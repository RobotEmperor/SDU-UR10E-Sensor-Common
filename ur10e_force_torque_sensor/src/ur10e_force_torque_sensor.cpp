...
Ur10eFTsensor::~Ur10eFTsensor()
{
  delete low_pass_filter_fx;
  delete high_pass_filter_fx;
  delete low_pass_filter_fy;
  delete high_pass_filter_fy;
  delete low_pass_filter_fz;
  delete high_pass_filter_fz;
  delete low_pass_filter_tx;
  delete high_pass_filter_tx;
  delete low_pass_filter_ty;
  delete high_pass_filter_ty;
  delete low_pass_filter_tz;
  delete high_pass_filter_tz;
...
void Ur10eFTsensor::initialize()
{
  ...
  kalman_filter_force_torque->Q =
      kalman_filter_force_torque->Q * gain_q;  // sensor noise filtering  --> can be modified a external file.
  kalman_filter_force_torque->R = kalman_filter_force_torque->R *
                                  gain_r_low_frequency;  // sensor noise filtering  --> can be modified a external file.
  ...
  kalman_filter_force_torque_temp->Q =
      kalman_filter_force_torque_temp->Q * gain_q;  // sensor noise filtering  --> can be modified a external file.
  kalman_filter_force_torque_temp->R =
      kalman_filter_force_torque_temp->R *
      gain_r_low_frequency;  // sensor noise filtering  --> can be modified a external file.
  ...
  // kalman_bucy_filter_force_torque->R = kalman_bucy_filter_force_torque->R*0.003; // sensor noise filtering  --> can
  // be modified a external file.
...
Eigen::MatrixXd Ur10eFTsensor::get_ft_filtered_data()
{
...
void PoseEstimation::initialize()
{
  ...
  kalman_filter_linear_acc->R =
      kalman_filter_linear_acc->R * 2000;  // sensor noise filtering  --> can be modified a external file.
}
